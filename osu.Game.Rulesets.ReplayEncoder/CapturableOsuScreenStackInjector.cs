...
public static class CapturableOsuScreenStackInjector
{
	static OsuGame Game
	{
		get => ReplayEncoderMain.Game;
		set => ReplayEncoderMain.Game = value;
	}

	static bool injected = false;

	static void InjectCapturableOsuScreenStack()
	{
		if (injected)
			return;
	...
	static class OsuGameLoadCompletePatch
	{
	...
	static class OsuGameDependenciesCacheDetector
	{
		static void Prefix()
		{
